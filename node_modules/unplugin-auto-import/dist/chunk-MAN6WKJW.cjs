...
var _chunkYALFP32Hcjs = require('./chunk-YALFP32H.cjs');
...
function normalizeImport(info, name) {
  ...
  return _chunkYALFP32Hcjs.__spreadValues.call(void 0, {
    name,
    as: name
  }, info);
}
...
${dts2}`;
  ...
  const importsPromise = flattenImports(options.imports, options.presetOverriding).then((imports) => {
    var _a2;
